        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="hidden md:flex mt-9 w-80 lg:w-96 bg-black/90 border-r border-gray-800/50 p-6 flex-shrink-0">
            <div className="bg-gradient-to-br from-purple-900/20 via-violet-900/20 to-blue-900/20 backdrop-blur-sm rounded-2xl p-6 border-2 border-purple-500/20 shadow-xl w-full">
              ...
              <div className="flex justify-center mb-6">
                <div className="w-24 h-24 bg-gradient-to-br from-purple-600 to-violet-600 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                  <img src="/chatbot.png" alt="SkillBot" className="w-full h-full object-cover" />
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-700/50">
                <button
                  onClick={handleClearChat}
                  className="w-full px-4 py-3 bg-red-600/70 hover:bg-red-600 text-white font-medium rounded-full transition-colors duration-200 flex items-center justify-center space-x-2"
                >
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="flex flex-col h-full max-w-5xl mx-auto w-full">
              ...
              {/* Messages */}
              <div className="bg-black/80 border-l border-gray-800/50 flex-1 overflow-y-auto px-3 md:px-4 py-4 space-y-4">
